...
function MobileMenu() {
  return (
    <>
      ...
      <div className='SecondMenu'/* className={Menu? 'SecondMenuEscape':'SecondMenu'} */>
        <ol>
              <li onClick={BackSecMenu} className='BackFirstMenu'><i class="fa-solid fa-angle-left"></i>Вернуться</li>
              <li onClick={Categ}>Категория ножей<i class="fa-solid fa-chevron-right"></i></li>
              <li onClick={Proizv}>Производство ножей<i class="fa-solid fa-chevron-right"></i></li>
              <li onClick={MarkStal}>Ножи по маркам стали<i class="fa-solid fa-chevron-right"></i></li>
              <li onClick={Zatoch}>Заточка и полировка ножей<i class="fa-solid fa-chevron-right"></i></li>
              <li onClick={Masterskaya}>Ножевая мастерская<i class="fa-solid fa-chevron-right"></i></li>
             
          </ol>
        </div>
        <div className='Categ'>
          <ol>
              <li onClick={BackCateg}><i class="fa-solid fa-angle-left"></i>Вернуться</li>
        ...
        <div className='Proizv'>
          <ol>
              <li onClick={BackProizv}><i class="fa-solid fa-angle-left"></i>Вернуться</li>
              <li>Ножи АИР</li>
              <li>Ножи ЗИК</li>
              <li>Ножи ЗЗОСС</li>
              <li>Ножи Уоружие</li>
        ...
        <div className='MarkStal'>
          <ol>
              <li onClick={BackMarkStal}><i class="fa-solid fa-angle-left"></i>Вернуться</li>
        ...
        <div className='Zatoch'>
          <ol>
              <li onClick={BackZatoch}><i class="fa-solid fa-angle-left"></i>Вернуться</li>
              <li>Паста ГОИ</li>
        ...
        <div className='Masterskaya'>
          <ol>
              <li onClick={BackMasterskaya}><i class="fa-solid fa-angle-left"></i>Вернуться</li>
